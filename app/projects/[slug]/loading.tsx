...
export default function ProjectDetailsLoading() {
	return (
		<section className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800 bg-transparent animate-pulse">
			<Container>
				{/* 1. BACK LINK SKELETON */}
				<div className="h-4 w-32 bg-gray-300 dark:bg-gray-700 rounded mb-8" />
				...
				<div className="mb-12">
					...
					<div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-6 mb-4">
						...
						<div className="h-12 md:h-16 w-3/4 max-w-2xl bg-gray-300 dark:bg-gray-700 rounded-lg order-1 md:order-2" />
					</div>
				...
				<div className="mb-12 w-full aspect-video md:h-112.5 bg-gray-300 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-700" />
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
						...
						<div>
							...
							<div className="pl-11 space-y-4">
								<div className="flex items-center gap-3">
									<div className="h-3 w-4 bg-gray-300 dark:bg-gray-700 rounded-sm" />
					...
					<div className="lg:col-span-1">
						<div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 p-6 shadow-sm sticky top-24">
							<div className="h-6 w-24 bg-gray-300 dark:bg-gray-700 rounded mb-5" />
							<div className="space-y-4">
								<div className="flex items-center gap-2">
									<div className="h-5 w-5 bg-gray-300 dark:bg-gray-700 rounded-full shrink-0" />
				...
				<div className="pt-12 border-t border-gray-200 dark:border-gray-800">
					<div className="h-8 w-48 bg-gray-300 dark:bg-gray-700 rounded-md mb-6" />
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						{[1, 2].map((i) => (
							<div
								key={i}
								className="p-6 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50"
							>
								<div className="h-3 w-16 bg-gray-300 dark:bg-gray-700 rounded mb-3" />
